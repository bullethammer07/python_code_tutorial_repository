...
print("index :",ival6.index("xyz"))  # --> This will return an exception


# ----------------------------------------------------------------------------------------------------------------------
"""
format()
Syntax : The format() method formats the specified value(s) and insert them inside the string's placeholder.
         The placeholder is defined using curly brackets: {}.
         
         txt1 = "My name is {fname}, I'am {age}".format(fname = "John", age = 36) --> by name
