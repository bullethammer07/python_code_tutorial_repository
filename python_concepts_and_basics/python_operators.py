...
# Operators are pretty much self expanatory :
# Python operators are of the below types :
...
#--------------------------------------------------------------------------------------------------------------------------------------------------
#   5. Python Bitwise Operators : Bitwise operators are used to compare (binary) numbers:
#--------------------------------------------------------------------------------------------------------------------------------------------------
